...
">
        ...
        <li style="width: 72px" class="mb-1">
            ...
            @if (Route::has('login'))
                <li class="mb-1">
                    <a style="color: #FFFFFF;" onmouseover="this.style.color='black';" onmouseout="this.style.color='white';"
                       class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{ route('login') }}">Вход</a>
                </li>
            @endif
            @if (Route::has('register'))
                    <li class="mb-1">
                        <a style="color: #FFFFFF;" onmouseover="this.style.color='black';" onmouseout="this.style.color='white';"
                           class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{ route('register') }}">Регистрация</a>
                    </li>
            @endif
        @else
            ...
            @endif
                <li class="mb-1">
                    <a style="color: #FFFFFF;" onmouseover="this.style.color='black';" onmouseout="this.style.color='white';"
                       class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{ route('logout') }}"
...
<div class="navbar-menu relative z-50 hidden">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto" style="width: 100%">
        ...
        <div>
            <ul>
                <li class="mb-1">
                    <a style="color: black" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="landing">Главная</a>
                </li>
                <li class="mb-1">
                    <a style="color: black" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="news">Новости</a>
                </li>
                <li class="mb-1">
                    <a style="color: black" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="rates">Тарифы</a>
                </li>
                <li class="mb-1">
                ...
                @guest
                    ...
                    <div class="mt-auto">
                        <div class="pt-6">
                            @if (Route::has('login'))
                                <a class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" href="{{ route('login') }}">Вход</a>
                            @endif
                            @if (Route::has('register'))
                                <a style="background: black"class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" href="{{ route('register') }}">Регистрация</a>
                            @endif
                        </div>
                    </div>
...
{{--                        </li>--}}
                        <li class="mb-1">
                            <a style="color: black" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{ route('userProfile') }}">{{ Auth::user()->name }}</a>
                        </li>
                    @endif
                    <li class="mb-1">
                        <a style="color: black" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{ route('logout') }}"
                           onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();">Выход</a>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST">@csrf</form>
                    </li>
